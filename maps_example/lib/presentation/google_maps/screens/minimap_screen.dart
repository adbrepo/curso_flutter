...
import 'package:maps_example/presentation/google_maps/widgets/minimap.dart';
...
class GoogleMapsMinimapScreen extends StatelessWidget {
  const GoogleMapsMinimapScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('GoogleMaps minimap'),
      ),
    ...
    return Container(
      ...
      child: GoogleMinimap(
        ...
        centerLocation: LatLng(
          utnMedranoLatLng.latitude,
          utnMedranoLatLng.longitude,
        ),
      ),
    );
  }
